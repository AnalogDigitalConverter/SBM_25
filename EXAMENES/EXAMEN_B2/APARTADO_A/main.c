...
int main(void)
{
  ...
  /*escritura tal cual. concatenar es fácil*/
  ...
  symbolToLocalBuffer(2,'=');
	...
	/*ESCRITURA MODO DOÑA*/
	borrar_todo_lcd();
	escribir_cadena("===asdf", 1);
	escribir_cadena("perico el de los palotis",2);
	//Se sobreescribe la línea. Pero concatenar es difícil
	escribir_cadena("pito",1);
