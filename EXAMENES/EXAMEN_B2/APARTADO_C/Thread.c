...
/*-----TIMER-------------*/
osTimerId_t id_countdown_timer;
...
void Thread (void *argument) {
  ...
  {
		id_countdown_timer = osTimerNew(lock_Callback, osTimerOnce, NULL, NULL);
    /*fsm in operation*/
    while(1)
    {
			//ESTE ORDEN PERMITE QUE PUEDAS ESPERARTE HASTA PULSAR, ASÍ SE PUEDE VER BIEN.
      osMessageQueueGet(id_joy_MsgQueue, &joy_rx_msg, NULL, osWaitForever);
			
			//CALLBACK 5 SEGUNDOS TRAS QUEUE_GET.
      osTimerStart(id_countdown_timer, 5000U);
