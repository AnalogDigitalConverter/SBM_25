...
//TIMER APB1 - TIM2, TIM3, TIM4, TIM5, TIM12, TIM13, TIM14
//TIMER APB2 - TIM1, TIM8, TIM9, TIM10, TIM11
//TIMER 1 Y 8  (ADVANCED)
//TIMER 2, 3, 4, 5 (general purpose 4 independent channels)
//TIMER 6, 7 APB1 basic timers (no imput or output capabilities)
//TIMER 10, 11, 13, 14 general purpose 1 independent channel
//TIMER 9, 12 general purpose 2 independent channel
...
//  tim2.Init.Period = 20999; // frec de 2 kHz
...
//   GPIO_InitTypeDef GPIO_InitStruct;
//   
//  //iniciar pin de salida (PB0)
//   __HAL_RCC_GPIOB_CLK_ENABLE();
//  
//  /* Leds */
//  GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
//  GPIO_InitStruct.Alternate = GPIO_AF2_TIM3;
//  GPIO_InitStruct.Pin = GPIO_PIN_0; //0 verde, 7 azul, 14 rojo
...
//  
//  tim3.Instance = TIM3;
//  tim3.Init.Prescaler = 41999; 
//  tim3.Init.Period = 1999; 
//  HAL_TIM_OC_Init(&tim3);
//  
//  TIM_Channel_InitStruct.OCMode = TIM_OCMODE_TOGGLE;
//  TIM_Channel_InitStruct.OCPolarity = TIM_OCPOLARITY_HIGH;
//  TIM_Channel_InitStruct.OCFastMode = TIM_OCFAST_DISABLE;
//  HAL_TIM_OC_ConfigChannel(&tim3, &TIM_Channel_InitStruct, TIM_CHANNEL_3);
//  
...
//   GPIO_InitTypeDef GPIO_InitStruct;
//   
//  //iniciar pin de salida (PB7)
//   __HAL_RCC_GPIOB_CLK_ENABLE();
//  
//  /* Leds */
//  GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
//  GPIO_InitStruct.Alternate = GPIO_AF2_TIM3;
//  GPIO_InitStruct.Pin = GPIO_PIN_7; //0 verde, 7 azul, 14 rojo
//  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
//  
//  
//  //timer 2
...
//  
//  tim4.Instance = TIM4;
//  tim4.Init.Prescaler = 41999; 
//  tim4.Init.Period = 1999; 
//  HAL_TIM_OC_Init(&tim4);
//  
//  TIM_Channel_InitStruct.OCMode = TIM_OCMODE_TOGGLE;
//  TIM_Channel_InitStruct.OCPolarity = TIM_OCPOLARITY_HIGH;
//  TIM_Channel_InitStruct.OCFastMode = TIM_OCFAST_DISABLE;
//  HAL_TIM_OC_ConfigChannel(&tim4, &TIM_Channel_InitStruct, TIM_CHANNEL_2);
//  
//  HAL_TIM_OC_Start(&tim4, TIM_CHANNEL_2);
  ...
  GPIO_InitStruct.Pin = GPIO_PIN_14; //0 verde, 7 azul, 14 rojo
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
  ...
  tim12.Instance = TIM12;
  tim12.Init.Prescaler = 41999; 
  tim12.Init.Period = 1999; 
  HAL_TIM_OC_Init(&tim12);
  
  TIM_Channel_InitStruct.OCMode = TIM_OCMODE_TOGGLE;
  TIM_Channel_InitStruct.OCPolarity = TIM_OCPOLARITY_HIGH;
  TIM_Channel_InitStruct.OCFastMode = TIM_OCFAST_DISABLE;
  HAL_TIM_OC_ConfigChannel(&tim12, &TIM_Channel_InitStruct, TIM_CHANNEL_1);
  
  HAL_TIM_OC_Start(&tim12, TIM_CHANNEL_1);
