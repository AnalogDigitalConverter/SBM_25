...
void HAL_GPIO_EXTI_Callback(uint16_t GPIO_Pin){
    ...
    HAL_TIM_Base_Start_IT(&htim7);
		...
		led1= cont & (1 << 2); // cont & 0x4
		led2= cont & (1 << 1); // cont & 0x2
		led3= cont & (1 << 0); // cont & 0x1
		
		if(led1) HAL_GPIO_WritePin(GPIOB, GPIO_PIN_0, GPIO_PIN_SET);
		else HAL_GPIO_WritePin(GPIOB, GPIO_PIN_0, GPIO_PIN_RESET);
		
		if(led2) HAL_GPIO_WritePin(GPIOB, GPIO_PIN_7, GPIO_PIN_SET);
		else HAL_GPIO_WritePin(GPIOB, GPIO_PIN_7, GPIO_PIN_RESET);
		
		if(led3) HAL_GPIO_WritePin(GPIOB, GPIO_PIN_14, GPIO_PIN_SET);
		else HAL_GPIO_WritePin(GPIOB, GPIO_PIN_14, GPIO_PIN_RESET);
		
		/*
		HAL_GPIO_WritePin(GPIOB, GPIO_PIN_0,  (led1 ? GPIO_PIN_SET : GPIO_PIN_RESET));
		HAL_GPIO_WritePin(GPIOB, GPIO_PIN_7,  (led2 ? GPIO_PIN_SET : GPIO_PIN_RESET));
		HAL_GPIO_WritePin(GPIOB, GPIO_PIN_14, (led3 ? GPIO_PIN_SET : GPIO_PIN_RESET));
		*/		
