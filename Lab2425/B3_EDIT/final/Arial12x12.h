...
const unsigned char Arial12x12[] = {//1ª columna: cuanto ocupa la letra -> Otras columnas que se pinta
//2ª columna es el primer byte de la Pagina 0 -> 3ª Columna, primer byte (columna 1) de la Pagina 1
//3ª columna es el segundo byte de la Pagina 0 -> 3ª Columna, segundo byte (columna 2)de la Pagina 1
//Cada letra ocupa 12 bits de alto de ancho
