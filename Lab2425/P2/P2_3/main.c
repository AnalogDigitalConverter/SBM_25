/* P2_1 - ANTONIO DONA CANDELA - 5OCT24 */
...
/* Corre el riesgo de olvidar inicializar reloj                              */
  ...
  /*GPIO HW Config*/
  GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
  /*PB11 currently in use as Output and not required. */
  /*Code left as-is for convenience as hw init        */
...
/**
  * @brief  Configures and Starts TIM2 in Output Compare Mode at 0.5ms
