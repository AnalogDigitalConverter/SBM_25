...
/* TIMER 7 CONFIG */
  ...
  //Up to 65535 factor, divide to 41999 (count 0 to 41999 for EOC)
  htim2.Init.Prescaler = 0;             //84MHz/1 = 84M (probar 0)
  
  //Generate EOC pulse interrupt at ? count
  htim2.Init.Period    = 41999;         //[41999 to 0] == 84M/42k = 2kHz
